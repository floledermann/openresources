...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'View.description_en'
        db.add_column('openresources_view', 'description_en',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'View.description_de'
        db.add_column('openresources_view', 'description_de',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'View.description_fr'
        db.add_column('openresources_view', 'description_fr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'View.description_en'
        db.delete_column('openresources_view', 'description_en')

        # Deleting field 'View.description_de'
        db.delete_column('openresources_view', 'description_de')

        # Deleting field 'View.description_fr'
        db.delete_column('openresources_view', 'description_fr')
    ...
    models = {
        ...
        'openresources.area': {
            ...
            'feature_order': ('django.db.models.fields.SmallIntegerField', [], {'default': '0', 'db_index': 'True'}),
