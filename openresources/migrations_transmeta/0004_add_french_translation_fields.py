...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TagTemplateGroup.name_fr'
        db.add_column('openresources_tagtemplategroup', 'name_fr', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'TagTemplate.name_fr'
        db.add_column('openresources_tagtemplate', 'name_fr', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'ResourceTemplate.name_fr'
        db.add_column('openresources_resourcetemplate', 'name_fr', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'ResourceTemplate.description_fr'
        db.add_column('openresources_resourcetemplate', 'description_fr', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Area.name_fr'
        db.add_column('openresources_area', 'name_fr', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'View.name_fr'
        db.add_column('openresources_view', 'name_fr', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TagTemplateGroup.name_fr'
        db.delete_column('openresources_tagtemplategroup', 'name_fr')

        # Deleting field 'TagTemplate.name_fr'
        db.delete_column('openresources_tagtemplate', 'name_fr')

        # Deleting field 'ResourceTemplate.name_fr'
        db.delete_column('openresources_resourcetemplate', 'name_fr')

        # Deleting field 'ResourceTemplate.description_fr'
        db.delete_column('openresources_resourcetemplate', 'description_fr')

        # Deleting field 'Area.name_fr'
        db.delete_column('openresources_area', 'name_fr')

        # Deleting field 'View.name_fr'
        db.delete_column('openresources_view', 'name_fr')
