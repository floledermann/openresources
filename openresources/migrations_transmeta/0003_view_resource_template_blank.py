...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'View.default_resource_template'
        db.alter_column('openresources_view', 'default_resource_template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['openresources.ResourceTemplate'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'View.default_resource_template'
        db.alter_column('openresources_view', 'default_resource_template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['openresources.ResourceTemplate'], null=True))
