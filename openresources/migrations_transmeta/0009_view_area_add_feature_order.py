...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Area.feature_order'
        db.add_column('openresources_area', 'feature_order',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'View.feature_order'
        db.add_column('openresources_view', 'feature_order',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Area.feature_order'
        db.delete_column('openresources_area', 'feature_order')

        # Deleting field 'View.feature_order'
        db.delete_column('openresources_view', 'feature_order')
