...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Area.shortname'
        db.alter_column('openresources_area', 'shortname', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100))
        # Adding unique constraint on 'Area', fields ['shortname']
        db.create_unique('openresources_area', ['shortname'])


    def backwards(self, orm):
        # Removing unique constraint on 'Area', fields ['shortname']
        db.delete_unique('openresources_area', ['shortname'])


        # Changing field 'Area.shortname'
        db.alter_column('openresources_area', 'shortname', self.gf('django.db.models.fields.SlugField')(max_length=50))
